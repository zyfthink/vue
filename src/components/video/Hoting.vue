        ...
        <li class="am-g am-list-item-desced pet_list_one_block">
            <div class="pet_list_one_info">
                <div class="pet_list_one_info_tytj">
                    <i class="iconfont-db pet_more_list_block_line_ico pet_list_tytj_ico" style="color:rebeccapurple;font-size:1.2em">&#xe61d;</i>影院热映</div>
...
export default {
    ...
    methods: {
        getHot() {
            var _this = this
            this.$http.get('/api/movie/in_theaters?count=6').then(function (res) {
                _this.HotData = res.data.subjects
                //请求成功 发送成功状态
